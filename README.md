...
2. **비트박스 Orbit** — Bukbak TV 스타일 강좌 리듬
   - STAGE 1–8 선택 (킥→하이햇→스네어→부츠앤캣츠→8비트→파이어빗→스로트→16비트)
   - **가이드 BGM = 탭 사운드** (같은 합성음, 크기만 다름) · 실제 배우는 느낌
   - 스테이지 클리어 시 확실히 종료 + 코인 → **비트 상점**(링/화살표 비트 스킨)
   - 3D 궤도 회전 · medium/hard **이중 원** 몰입
   - 탭/스페이스 = 궤도 반전(+하드 시 레인 전환) + 비트박스 리드
